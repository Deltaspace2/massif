...
# Both live in `prose.py` now, which imports selectolax and nothing else.
# Re-exported here because `hut_sites`, `llm_probe` and the tests import them
# from this module, and the move was about the IMPORT GRAPH rather than about
# where the code reads best. See that module's docstring.
from massif.ingest.prose import _CONTENT as _CONTENT  # noqa: E402
from massif.ingest.prose import _FURNITURE as _FURNITURE  # noqa: E402
from massif.ingest.prose import normalise_space as normalise_space  # noqa: E402
from massif.ingest.prose import readable_text as readable_text  # noqa: E402
